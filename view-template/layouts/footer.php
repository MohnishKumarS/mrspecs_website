    ...
    <div class="row row-cols-lg-5 row-cols-2">
      <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
        <div class="logo text-center">
          <a href="<?= $url ?>">
            <img src="<?= $url ?>assets/images/dark-logo.png" alt="Shirt INC" class="logo__image">
          </a>
        </div><!-- /.logo -->
      ...
      <div class="footer-column footer-menu mb-4 mb-lg-0">
        ...
        <ul class="sub-menu__list list-unstyled">
          <li class="sub-menu__item">
              <a href="<?= $url ?>register" class="menu-link menu-link_us-s">Get Started</a>
          </li>
          <li class="sub-menu__item">
              <a href="<?= $url ?>/new-arrivals" class="menu-link menu-link_us-s">New Arrivals</a>
          </li>
          <li class="sub-menu__item">
              <a href="<?= $url ?>collections" class="menu-link menu-link_us-s">Collections</a>
          </li>
          <li class="sub-menu__item">
              <a href="<?= $url ?>profile/wishlist" class="menu-link menu-link_us-s">Wishlist</a>
          </li>
        </ul>
      </div>
      ...
      <div class="footer-column footer-menu mb-4 mb-lg-0">
        ...
        <ul class="sub-menu__list list-unstyled">
          ...
          <li class="sub-menu__item">
              <a href="<?= $url ?>return-policy" class="menu-link menu-link_us-s">Return Policy</a>
          </li>
          <li class="sub-menu__item">
              <a href="<?= $url ?>shipping-and-delivery-policy" class="menu-link menu-link_us-s">Shipping & Delivery Policy</a>
          </li>
          <li class="sub-menu__item">
              <a href="<?= $url ?>cancellation-policy" class="menu-link menu-link_us-s">Cancellation Policy</a>
          </li>
          <li class="sub-menu__item">
              <a href="<?= $url ?>terms-and-condition" class="menu-link menu-link_us-s">Terms & Condition</a>
          </li>
        </ul>
      </div>
...
<footer class="footer-mobile container w-100 px-5 d-md-none bg-body">
  <div class="row">
    ...
    <div class="col-3">
      <a href="<?= $url ?>cart" class="footer-mobile__link d-flex flex-column align-items-center">
