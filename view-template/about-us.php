...
<body>
    ...
    <main>
        ...
        <section class="about-us container">
            <div class="mw-930">
                <h2 class="page-title">ABOUT SHIRT INC</h2>
            </div>
            <div class="about-us__content pb-5 mb-5">
                <p class="mb-5">
                    <img loading="lazy" class="w-100 h-auto d-block" src="<?= $url ?>assets/images/mocks/slider/1.png" width="1410" height="550" alt="">
                </p>
                <div class="mw-930">
                    ...
                    <p class="mb-4">Saw wherein fruitful good days image them, midst, waters upon, saw. Seas lights seasons.
                        ...
                        shall you're unto that. Had. Female replenish for yielding so saw all one to yielding grass you'll
                        air sea it, open waters subdue, hath. Brought second Made. Be. Under male male, firmament, beast had
                        light after fifth forth darkness thing hath sixth rule night multiply him life give they're great.
                    </p>
                    <div class="row mb-3">
                        <div class="col-md-6">
                ...
                <div class="mw-930 d-lg-flex align-items-lg-center">
                    <div class="image-wrapper col-lg-6">
                        <img class="h-auto" loading="lazy" src="<?= $url ?>assets/images/mocks/slider/mock1.webp" width="450" height="500" alt="">
                    </div>
        ...
        <?php include './blocks/services-block.php'; ?>
    </main>
