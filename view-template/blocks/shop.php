<?php
if (!isset($limit)) {
    echo '<section class="full-width_padding">
...
<section class="shop-main container">
    <?php
    if (!isset($limit)) {
        echo '<div class="d-flex justify-content-between mb-4 pb-md-2">
                            ...
                            <div class="swiper-container background-img js-swiper-slider" data-settings=\'{"resizeObserver": true}\'>
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="' . $url . 'product">
                                            <img loading="lazy" src="' . $url . 'assets/images/mocks/slider/mock7.jpg" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                        </a>
                                    </div>
                                    <div class="swiper-slide">
                                        <a href="' . $url . 'product">
