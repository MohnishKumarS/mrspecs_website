            ...
            <div class="product-single__media" data-media-type="vertical-thumbnail">
                    ...
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock7.jpg" width="674" height="674" alt="">
                                <a data-fancybox="gallery" href="<?= $url ?>assets/images/mocks/slider/mock7.jpg" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                            ...
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock1.webp" width="674" height="674" alt="">
                                <a data-fancybox="gallery" href="<?= $url ?>assets/images/mocks/slider/mock1.webp" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use href="#icon_zoom" />
                                    </svg>
                                </a>
                            ...
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock6.jpg" width="674" height="674" alt="">
                                <a data-fancybox="gallery" href="<?= $url ?>assets/images/mocks/slider/mock6.jpg" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use href="#icon_zoom" />
                                    </svg>
                                </a>
                            ...
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock2.jpg" width="674" height="674" alt="">
                                <a data-fancybox="gallery" href="<?= $url ?>assets/images/mocks/slider/mock2.jpg" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <use href="#icon_zoom" />
                                    </svg>
                                </a>
                ...
                <div class="product-single__thumbnail">
                    <div class="swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock7.jpg" width="104" height="104" alt="">
                            </div>
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock1.webp" width="104" height="104" alt="">
                            </div>
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock6.jpg" width="104" height="104" alt="">
                            </div>
                            <div class="swiper-slide product-single__image-item">
                                <img loading="lazy" class="h-auto" src="<?= $url ?>assets/images/mocks/slider/mock2.jpg" width="104" height="104" alt="">
                            </div>
                        </div>
                    </div>
                </div>
